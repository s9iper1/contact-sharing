...
public class ForgotPasswordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    class RecoverPasswordTask extends AsyncTask<Void, Integer, Integer> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            WebServiceHelper.showProgressDialog(ForgotPasswordActivity.this, "Sending Recovery Mail");
        }
        ...
        protected Integer doInBackground(Void... params) {
            ...
            if (WebServiceHelper.isNetworkAvailable() && WebServiceHelper.isInternetWorking()) {
                try {
                    response = WebServiceHelper.forgotPassword(mEmailAddressString);
    ...
    class ChangePasswordTask extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            WebServiceHelper.showProgressDialog(ForgotPasswordActivity.this, "Generating New Password");
        }
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (WebServiceHelper.isNetworkAvailable() && WebServiceHelper.isInternetWorking()) {
                try {
                    response = WebServiceHelper.changePassword(
                            mEmailAddressString,
